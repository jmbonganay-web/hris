...
export default async function PayrollPage() {
  ...
  return <div className="payroll-layout"><PageHeader title="Payroll" description="Manage payroll schedules, periods, compensation setup, and approvals." action={<div className="header-actions"><Link className="btn" href="/payroll/schedules">Schedules</Link><Link className="btn" href="/payroll/periods">Periods</Link>{access.canApprove ? <Link className="btn primary" href="/payroll/approvals">Approvals</Link> : null}</div>} /><div className="payroll-overview-grid"><PayrollSummaryCards overview={overview} /><PayrollMissingSetupList employees={overview.missingEmployees} /></div></div>;
}
