  ...
  return (
    <>
      <PageHeader
        ...
        action={<div className="header-actions"><Link className="btn" href="/employees">Back</Link>{access.canManage && <Link className="btn primary" href={`/employees/${employee.id}/employment/edit`}>Edit employment</Link>}</div>}
      />
